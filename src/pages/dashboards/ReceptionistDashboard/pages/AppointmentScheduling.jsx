...
const handleSelectDoc = (doc) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const computed_department_id = deptObj ? (deptObj.id || deptObj.department_id || formData.department_id) : formData.department_id;
      
      const docObj = apiDoctors.find(d => (d.name || d) === formData.doctor_name);
      const computed_doctor_id = docObj ? (docObj.id || docObj.doctor_id || formData.doctor_id) : formData.doctor_id;

const payload = {
  patient_ref: formData.patient_ref,
  patient_name: formData.patient_name,
  patient_id: formData.patient_id || undefined,
  patient: formData.patient_id || undefined,
